...
import { ENTITY_DUPLICATED, ENTITY_NOT_FOUND, ErrorCode, INVALID_REQUEST } from "./error-code";
...
export const EntityDuplicatedException = (message?: string): ServiceException => {
