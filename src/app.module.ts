...
import { MeetingsSchedulesModules as MeetingsSchedulesModules } from './meetings/schedules/meetings.schedules.module';

@Module({
  imports: [
    TimezonesModule,
    MeetingsSchedulesModules,
    MeetingsVotesModules,
    UsersModule,
